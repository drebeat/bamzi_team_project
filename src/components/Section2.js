    ...
    <>
      <div className="rightbg-image">
        ...
        <div className="lg:flex px-28">
          <div className="flex-flex-col justify-center items-center bg-bgcolors rounded-lg px-10 pt-12 pb-2">
            <img src={image6} alt="" className="px-6" />
            <div className="text-center font-bold text-lg">Make More Money</div>
            <div className="text-gray-600 text-center break-words px-1 md:px-4">
              Save time, avoid losing work and information,delegate, and track
              tasks to stay on schedule
            </div>
          </div>
          <div className="bg-primary rounded pt-8 my-14 x-14">
            <img src={image7} alt="" />
